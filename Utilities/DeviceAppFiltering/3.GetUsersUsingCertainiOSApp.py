...
print('\033[1;33m You will only get iPhone App List running this!\033[0m')
# Take user input for the app name
app_name = input("Enter the iOS app name: ")
...
with open('iPhoneAppList.json', 'r') as f:
    data = json.load(f)
...
output_file_name = f"{app_name}_iPhoneAppList.json"
